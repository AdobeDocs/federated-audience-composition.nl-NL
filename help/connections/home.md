...
>[!IMPORTANT]
>
>Federated Audience Composition biedt ondersteuning voor gefederaliseerde verbindingsinstellingen met Oracle-databaseversie 11g of hoger en gehost op AWS, Azure, Exadata of een privécloud (mits deze toegankelijk is via een extern netwerk). Neem contact op met de Adobe Customer Care als u nog vragen hebt over het instellen van de Oracle-database of als u een veilige verbinding met Oracle wilt maken.
