...
Bovendien kunt u de gegevensvervaldatum voor het publiek instellen. De gegevensvervaldatum bepaalt het aantal dagen waarna het publiekslidmaatschap zal verlopen. De gegevensvervaldatum kan variëren van 1 tot 90 dagen. Deze waarde is standaard ingesteld op 30.

+++

#### Velden opslaan {#save-fields}

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset"
>title="Velden opslaan"
>abstract="Met de activiteit Velden opslaan kunt u Experience Platform-schema&#39;s verrijken door gegevens van externe opslagruimten te federaliseren, zodat u Experience Platform-schema&#39;s kunt verfraaien met extra kenmerken. "

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_primaryidentitynamespace"
>title="Primair naamruimte-veld identificeren"
>abstract="De naamruimte voor de primaire identiteit. De naamruimte helpt context te bieden waarin de classificatie van de primaire identiteit wordt beschreven."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_selectaepschema"
>title="Experience Platform-schema selecteren"
>abstract="Kies het Experience Platform-schema dat u wilt verrijken."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_updatemode"
>title="Modus voor bijwerken van velden opslaan"
>abstract="De beschikbare updatemodi voor sparen gebiedsactiviteit omvatten volledige update en stijgende update."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_updatemode_full"
>title="Volledige update"
>abstract="De volledige updatemodus werkt de volledige set kenmerken in de geselecteerde schema&#39;s bij."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_updatemode_incremental"
>title="Incrementele update"
>abstract="De incrementele updatemodus werkt de velden bij die zijn gewijzigd sinds de laatste verrijking."
...
>title="Schema-lijst"
>abstract="Een lijst met de schema&#39;s die beschikbaar zijn in uw sandbox. U kunt of standaard of relationele schema&#39;s selecteren."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_selectaepattribute"
>title="Kenmerk selecteren"
>abstract="U kunt een bron-/doeltoewijzing voor de velden maken."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_selectaepdataset"
>title="Gegevensset selecteren"
>abstract="Een lijst van de datasets die tot het schema behoren. U kunt selecteren aan welke dataset u de verrijkte gegevens wilt worden bewaard."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_primarykeycheck"
>title="Primaire sleutel"
>abstract="De primaire sleutel voor het relationele schema. Deze waarde zorgt ervoor dat de gegevenssets uniek zijn door dubbele records te voorkomen."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_versiondescriptor"
>title="Versiebeschrijving"
>abstract="De versiedescriptor voor het relationele schema. Met deze waarde kunt u bepalen welke eigenschap voorrang heeft als meerdere waarden dezelfde primaire sleutel delen. Op deze manier weet u zeker dat de nieuwste update wordt toegepast."

>[!CONTEXTUALHELP]
>id="dc_orchestration_savedataset_timestampdescriptor"
>title="Tijdstempelbeschrijving"
>abstract="De tijdstempelbeschrijving voor het relationele schema. Met deze waarde kunt u de tijd van de gebeurtenis instellen om te bestellen. Deze waarde bestaat alleen als u werkt met gegevens uit tijdreeksen."

Met de activiteit **[!UICONTROL Save Fields]** kunt u Experience Platform-schema&#39;s verrijken door gegevens uit externe opslagplaatsen te federaliseren, zodat u Experience Platform-schema&#39;s kunt verrijken met extra kenmerken.

Deze activiteit wordt gebruikt om schema&#39;s te verrijken door extra attributen en inzichten in te brengen zonder fysisch het bewegen of het dupliceren van de gegevens in het platform.

+++ Configuratiedetails

>[!IMPORTANT]
>
>Als de geselecteerde dataset **niet** toegelaten upsert heeft, zullen de gegevens **&#x200B;**&#x200B;worden vervangen. Leren hoe te om upsert voor uw datasets toe te laten, te lezen gelieve [&#x200B; toelaten upsert gids &#x200B;](https://experienceleague.adobe.com/en/docs/experience-platform/catalog/datasets/enable-upsert).

Nadat u de **[!UICONTROL Save Fields]** -activiteit aan uw compositie hebt toegevoegd, kunt u een label aan de activiteit geven en het Adobe Experience Platform-schema selecteren dat u wilt gebruiken. Het schema kan een standaardschema of een relationeel schema zijn.

![&#x200B; de beschikbare schema&#39;s worden getoond.](/help/compositions//assets/activities/enrich-fields/select-schema.png){width="1500" zoomable="yes"}

>[!BEGINTABS]

>[!TAB  Standaard schema ]

Als u een standaardschema selecteert, zult u de dataset moeten kiezen de verrijking wordt bewaard aan.

![&#x200B; de uitgezochte datasetsectie wordt benadrukt.](/help/compositions/assets/activities/enrich-fields/select-dataset-standard.png){width="300" zoomable="yes"}

Na het selecteren van de dataset, kunt u het primaire identiteitsgebied zien dat zal worden gebruikt om profielen in het gegevensbestand te identificeren. Nochtans, zult u de primaire en vereiste gebieden moeten in kaart brengen. Selecteer **[!UICONTROL Add fields]** en geef het veld **[!UICONTROL Source]** (externe gegevens) en het veld **[!UICONTROL Destination]** (schemaveld) op voor elk kenmerk dat u wilt toewijzen.

![&#x200B; voegt gebiedsknoop toe en de sectie van de gebiedstoewijzing wordt benadrukt.](/help/compositions/assets/activities/enrich-fields/specify-mapping-standard.png){width="300" zoomable="yes"}

U kunt ook de updatemodus voor de verrijking opgeven.

![&#x200B; de types van updatemodus worden getoond.](/help/compositions/assets/activities/enrich-fields/select-update-mode.png){width="300" zoomable="yes"}

| Modus Bijwerken | Beschrijving |
| ----------- | ----------- |
| Volledige updates | De volledige set kenmerken in de geselecteerde schema&#39;s wordt bijgewerkt voor verrijking. |
| Incrementele updates | Alleen de velden die zijn gewijzigd sinds de laatste verrijking worden bijgewerkt voor de verrijking. |
...
>[!TAB  Relationeel schema ]

Als u een relationeel schema selecteert, zult u de dataset moeten kiezen de verrijking wordt bewaard aan.

![&#x200B; de uitgezochte datasetsectie wordt benadrukt.](/help/compositions/assets/activities/enrich-fields/select-dataset-relational.png){width="300" zoomable="yes"}

Na het selecteren van de dataset, kunt u de primaire sleutel en versiedescriptor voor het gegevensbestand zien.  Nochtans, zult u de primaire sleutel en de vereiste gebieden moeten in kaart brengen. Selecteer **[!UICONTROL Add field]s** en specificeer het **[!UICONTROL Source]** gebied (externe gegevens) en het **[!UICONTROL Destination]** gebied (schemagebied) voor elk attribuut u wilt in kaart brengen.

![&#x200B; voegt gebiedsknoop toe en de sectie van de gebiedstoewijzing wordt benadrukt.](/help/compositions/assets/activities/enrich-fields/specify-mapping-relational.png){width="300" zoomable="yes"}

Aangezien relationele schema&#39;s slechts stijgende updates steunen, zult u de laatste gewijzigde datum moeten kiezen om te bepalen welke gegevens worden verzonden. In incrementele updates worden alleen de velden bijgewerkt die zijn gewijzigd sinds de laatste verrijkingsuitvoering.

![&#x200B; de updatemodus, stijgende updates, wordt getoond.](/help/compositions/assets/activities/enrich-fields/update-mode-relational.png){width="300" zoomable="yes"}
