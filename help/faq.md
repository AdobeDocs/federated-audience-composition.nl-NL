...
Als u Federated Audience Composition wilt gebruiken, moet elke gebruiker worden toegevoegd aan een specifiek profiel dat voor elke sandbox is gemaakt. Voor meer informatie, verwijs naar de [&#x200B; pagina van de Samenstelling van het Publiek van de 1&rbrace; Verbond van de Toegang.](./start/access-prerequisites.md)
...
Momenteel worden de volgende wolkenpakhuizen ondersteund:
...
Voor meer informatie bij het verbinden met een gegevenspakhuis, lees het [&#x200B; overzicht van verbindingen &#x200B;](./connections/home.md).
...
## Bestaat er tijdelijke opslag in Federated Audience Composition?
...
## Houdt Federated Audience Composition een fysiek exemplaar van die lijst van mensen op om naar stroomafwaartse systemen te verzenden?
...
## Als de gegevens voor de Aanmaak van het Publiek en de Verrijking van de Publiek gebruiks gevenpatronen niet worden voortgeduurd, hoe wordt het tijdelijk opgeslagen?
...
Ja, kunt u het publiek van de Samenstelling van het Federale Publiek binnen de Portaal van het Publiek schrappen.
...
## Hoe kan ik privacyverzoeken met Federated Audience Composition creëren en beheren?
